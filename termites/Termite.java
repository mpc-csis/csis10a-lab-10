/*
 * This program is part of an exercise in Think Java (thinkapjava.com) Copyright(c) 2011 Allen B.
 * Downey (http://allendowney.com)
 *
...
public class Termite extends Bug {
    ...
    /*
     * Checks whether the termite can move. Note: unlike most Bugs, termites can't move onto
     * flowers.
     */
    ...
    /*
     * Moves in the direction the termite is facing. Drops a flower, if one has been dropped, in the
     * old location.
     */
    public void move() {
        Location next = getNextLocation();
     ...
     * 
     * Note: only one Actor can occupy a grid cell, so the effect of dropping a flower is delayed
     * until the termite moves.
     */
    ...
    /*
     * Picks up the flower the termite is facing, if there is one, and if the termite doesn't
    ...
    /*
     * Gets the contents of the location the termite is facing. Returns null if the location is
     * empty or invalid.
     */
